...
pub const SM100_U8x8_LDSM_T = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.m16n16.x1.trans.shared.b8 {%[d0] %1}, [%2];",
    .is_async = false,
};
...
pub const SM100_U8x16_LDSM_T = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.m16n16.x2.trans.shared.b8 {%[d0] %1, %2, %3}, [%4];",
    .is_async = false,
};
...
pub const SM100_SU4_DU8x16_x1_LDSM_N = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.m8n16.x1.shared.b8x16.b4x16_p64  {%[d0]} [%1];",
    .is_async = false,
};
...
pub const SM100_SU6_DU8x16_x1_LDSM_N = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 1 },
    .ptx = "ldmatrix.sync.aligned.m8n16.x1.shared.b8x16.b6x16_p32  {%[d0]} [%1];",
    .is_async = false,
};
...
pub const SM100_SU4_DU8x16_x2_LDSM_N = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 2 },
    .ptx = "ldmatrix.sync.aligned.m8n16.x2.shared.b8x16.b4x16_p64  {%[d0] %1}, [%2];",
    .is_async = false,
};
...
pub const SM100_SU6_DU8x16_x2_LDSM_N = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 2 },
    .ptx = "ldmatrix.sync.aligned.m8n16.x2.shared.b8x16.b6x16_p32  {%[d0] %1}, [%2];",
    .is_async = false,
};
...
pub const SM100_SU4_DU8x16_x4_LDSM_N = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 4 },
    .ptx = "ldmatrix.sync.aligned.m8n16.x4.shared.b8x16.b4x16_p64  {%[d0] %1, %2, %3}, [%4];",
    .is_async = false,
};
...
pub const SM100_SU6_DU8x16_x4_LDSM_N = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 4 },
    .ptx = "ldmatrix.sync.aligned.m8n16.x4.shared.b8x16.b6x16_p32  {%[d0] %1, %2, %3}, [%4];",
    .is_async = false,
};
...
pub const SM100_U8x4_STSM_T = types.CopyInst {
    ...
    .ptx = "stmatrix.sync.aligned.m16n8.x1.trans.shared.b8 [%[d0]] {%1};",
    .is_async = false,
};
...
pub const SM100_U8x8_STSM_T = types.CopyInst {
    ...
    .d_regs = .{ .ty = u128, .count = 1 },
    .ptx = "stmatrix.sync.aligned.m16n8.x2.trans.shared.b8 [%[d0]] {%1, %2};",
    .is_async = false,
};
...
pub const SM100_U8x16_STSM_T = types.CopyInst {
    ...
    .d_regs = .{ .ty = u128, .count = 1 },
    .ptx = "stmatrix.sync.aligned.m16n8.x4.trans.shared.b8 [%[d0]] {%1, %2, %3, %4};",
    .is_async = false,
};
