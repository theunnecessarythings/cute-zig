...
pub const SM75_U32x1_LDSM_N = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.x1.m8n8.shared.b16 {%0}, [%1];",
    .is_async = false,
};
...
pub const SM75_U32x2_LDSM_N = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.x2.m8n8.shared.b16 {%0, %1}, [%2];",
    .is_async = false,
};
...
pub const SM75_U32x4_LDSM_N = types.CopyInst {
    ...
    .ptx = "ldmatrix.sync.aligned.x4.m8n8.shared.b16 {%0, %1, %2, %3}, [%4];",
    .is_async = false,
};
...
pub const SM75_U16x2_LDSM_T = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 1 },
    .ptx = "ldmatrix.sync.aligned.x1.trans.m8n8.shared.b16 {%0}, [%1];",
    .is_async = false,
};
...
pub const SM75_U16x4_LDSM_T = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 2 },
    .ptx = "ldmatrix.sync.aligned.x2.trans.m8n8.shared.b16 {%0, %1}, [%2];",
    .is_async = false,
};
...
pub const SM75_U16x8_LDSM_T = types.CopyInst {
    ...
    .s_regs = .{ .ty = u128, .count = 1 },
    .d_regs = .{ .ty = u32, .count = 4 },
    .ptx = "ldmatrix.sync.aligned.x4.trans.m8n8.shared.b16 {%0, %1, %2, %3}, [%4];",
    .is_async = false,
};
